...
CUDA_VISIBLE_DEVICES=2,3 python -m torch.distributed.run --nproc_per_node=2 --master_port=25001 llava/train/train_no_deepspeed.py \
    ...
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir ../../../../../ssss/Datasets/llava-pretrain/checkpoints/llava-tokenpacker-pretrain/siglip_large_qwen_1.7 \
    --num_train_epochs 1 \
